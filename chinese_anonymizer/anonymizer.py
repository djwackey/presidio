...
class ChineseAnonymizer:
    ...
    def anonymize(self, text: str, analyzer_results=None, anonymize_entities: Optional[Dict[str, str]] = None):
        ...
        if anonymize_entities:
            ...
            for entity_type, replacement in anonymize_entities.items():
                operators[entity_type] = {"type": "replace", "new_value": replacement}
    ...
    def anonymize_text(self, text: str, entities: Optional[List[str]] = None, 
                      anonymize_entities: Optional[Dict[str, str]] = None, language: str = "zh"):
        """
        一步完成文本分析和脱敏
        ...
        return self.anonymize(text=text, analyzer_results=analyzer_results, 
